...
# prepare summary: multi active portfolio, SP active, SP buy-and-hold
...
try:
    with pd.ExcelWriter("simulation_corrected.xlsx", engine="openpyxl") as writer:
    ...
    print("Fichier créé : simulation_corrected.xlsx")
...
print("SP Active:", stats_from_series(summary["PortfolioValue_SPActive"]))
